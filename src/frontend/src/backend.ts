...
export class Backend implements backendInterface {
    ...
    async getSongs(): Promise<Array<Song>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSongs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async likeSong(arg0: bigint): Promise<Song> {
        if (this.processError) {
            try {
    ...
    async uploadSong(arg0: string, arg1: string, arg2: string, arg3: string): Promise<Song> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadSong(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
